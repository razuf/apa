defmodule Test do
  ...
  ### test calc digits
  def calc_digits(0) do
    # IO.inspect(binding(), label: "### binding NO")
    1
  end

  def calc_digits(l) do
    # IO.inspect(binding(), label: "### binding start")
    do_calc_digits(1, l)
  end

  def do_calc_digits(acc, l)
      when l >=
             100_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000 do
    do_calc_digits(
      acc + 605,
      Kernel.div(
        l,
  ...
  def do_calc_digits(acc, l)
      when l >=
             100_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000 do
    # IO.inspect(binding(), label: "### binding 128")

    do_calc_digits(
      acc + 128,
      Kernel.div(
        l,
        100_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000
      )
    )
  end
  ...
  def do_calc_digits(acc, l)
      when l >=
             10_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000 do
    # IO.inspect(binding(), label: "### binding 64")

    do_calc_digits(
      acc + 64,
      Kernel.div(
        l,
        10_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000_000
      )
    )
  end

  def do_calc_digits(acc, l)
      when l >= 1_000_000_000_000_000_000_000_000_000_000_000_000_000_000 do
    # IO.inspect(binding(), label: "### binding 42")

    do_calc_digits(
      acc + 42,
      Kernel.div(l, 1_000_000_000_000_000_000_000_000_000_000_000_000_000_000)
    )
  end

  def do_calc_digits(acc, l) when l >= 100_000_000_000_000_000_000_000_000_000_000 do
    # IO.inspect(binding(), label: "### binding 32")

    do_calc_digits(acc + 32, Kernel.div(l, 100_000_000_000_000_000_000_000_000_000_000))
  end

  def do_calc_digits(acc, l) when l >= 10_000_000_000_000_000 do
    # IO.inspect(binding(), label: "### binding NO")
    do_calc_digits(acc + 16, Kernel.div(l, 10_000_000_000_000_000))
  end

  def do_calc_digits(acc, l) when l >= 100_000_000 do
    # IO.inspect(binding(), label: "### binding NO")
    do_calc_digits(acc + 8, Kernel.div(l, 100_000_000))
  end

  def do_calc_digits(acc, l) when l >= 10000 do
    # IO.inspect(binding(), label: "### binding NO")
    do_calc_digits(acc + 4, Kernel.div(l, 10000))
  end

  def do_calc_digits(acc, l) when l >= 100 do
    # IO.inspect(binding(), label: "### binding NO")
    do_calc_digits(acc + 2, Kernel.div(l, 100))
  end

  def do_calc_digits(acc, l) when l >= 10 do
    # IO.inspect(binding(), label: "### binding NO")
    do_calc_digits(acc + 1, Kernel.div(l, 10))
  end

  def do_calc_digits(acc, l) when l >= 1 do
    # IO.inspect(binding(), label: "### binding exit")
  ...
  def log_digits(int_value) when int_value < @max_erlang_math_log do
    trunc(:math.log10(int_value)) + 1
  end

  # special because log10( > @max_erlang_math_log) is not possible
  def log_digits(int_value) do
    str_digits(int_value)
  end

  # str
  def str_digits(int_value) do
    int_value
    |> Integer.to_string()
    |> Kernel.byte_size()
  end
...
inputs = %{
  ...
  # for float with exponent testing
  # # "3 Digits Integer" => {123, -1},
  # # "6 Digits Integer" => {123_456, -3},
  # "a 9 Digits Integer" => {123_456_789, -3},
  # # "b 12 Digits Integer" => {123_456_789_012, -3},
  # # "c 15 Digits Integer" => {123_456_789_012_345, -3},
  # # "d 18 Digits Integer" => {123_456_789_012_345_678, -3},
  # "e 21 Digits Integer" => {123_456_789_012_345_678_901, -3},
  # # "f 24 Digits Integer" => {123_456_789_012_345_678_901_234, -3},
  # "g 42 Digits Integer" => {123_456_789_012_345_678_901_234_567_890_123_456_789_012, -3}
  "g 43 Digits Integer" => {123_456_789_012_345_678_901_234_567_890_123_456_789_0123, -3},
  # "h 100 Digits Integer" =>
  ...
  #    -3},
  # # "i 200 Digits Integer" =>
  # #   {12_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890,
  # #    -3},
  # # "j 300 Digits Integer" =>
  # #   {123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890,
  # #    -3},
  "k 606 Digits Integer" =>
    {123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_011_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_112_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_011_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_112_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901,
     -3}

  ###
  # "a 9 Digits + Integer" => {123_456_789, -3},
  # "b 9 Digits - Integer" => {-123_456_789, -3},
  # "c 21 Digits + Integer" => {123_456_789_012_345_678_901, -3},
  # "d 21 Digits - Integer" => {-123_456_789_012_345_678_901, -3},
  # "e 42 Digits + Integer" => {123_456_789_012_345_678_901_234_567_890_123_456_789_012, -3},
  # "f 42 Digits - Integer" => {-123_456_789_012_345_678_901_234_567_890_123_456_789_012, -3},
  # "g 100 Digits + Integer" =>
  #   {1_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890,
  #    -3},
  # "h 100 Digits - Integer" =>
  #   {-1_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890,
  ...
  # #   {123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890,
  # #    -3},
  # "i 606 Digits + Integer" =>
  #   {123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_011_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_112_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_011_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_112_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901,
  #    -3},
  # "j 606 Digits - Integer" =>
  #   {-123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_011_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_112_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_011_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_112_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901_234_567_890_123_456_789_012_345_678_901,
  #    -3}
}

bench = %{
  "a digits with calc()" => fn {l, r} -> Test.calc_digits(l) end,
  # "b digits with  log()" => fn {l, r} -> trunc(:math.log10(l)) + 1 end
  "b digits with  log()" => fn {l, r} -> Test.log_digits(l) end,
  "c digits with  str()" => fn {l, r} -> Test.str_digits(l) end

  # 1. abs 2. -
  # "abs(l)" => fn {l, r} -> abs(l) end,
  # "-  (l)" => fn {l, r} -> if l < 0, do: -l, else: l end

  # 1. log 2. str 3. div
  # "ApaDiv.div_digits(l)" => fn {l, r} -> ApaDiv.div_digits(l, 0) end,
  # "ApaDiv.str_digits(l)" => fn {l, r} -> ApaDiv.str_digits(l) end,
  # "ApaDiv.log_digits(l)" => fn {l, r} -> ApaDiv.log_digits(l) end

  # defp log_digits(0) do
  #   1
  # end

  # defp log_digits(int_value) when int_value < @max_erlang_math_log do
  #   trunc(:math.log10(int_value)) + 1
  # end

  # def div_digits(int_value, acc) when int_value >= 1 do
  #   div_digits(Kernel.div(int_value, 10), acc + 1)
  # end

  # def div_digits(int_value, acc) do
  #   acc
  # end
